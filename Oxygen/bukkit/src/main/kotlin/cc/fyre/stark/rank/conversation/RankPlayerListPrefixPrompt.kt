 ...
 */
class RankPlayerListPrefixPrompt(val rank: Rank) : StringPrompt() {

    override fun getPromptText(conversationContext: ConversationContext): String {
        return ChatColor.GREEN.toString() + "Please specify a valid playerListPrefix."
    }
    ...
    override fun acceptInput(conversationContext: ConversationContext, s: String): Prompt? {
        ...
        conversationContext.setSessionData("playerListPrefix", s)
