...
public abstract class Ability implements Listener {
    ...
    public boolean isSimilar(ItemStack itemStack) {
        ...
        return itemStack.getType() == this.getMaterial() &&
                itemStack.getItemMeta().getDisplayName().equals(this.getDisplayName())
                && itemStack.getItemMeta().getLore().equals(this.getLore().stream().map(s -> ChatColor.translateAlternateColorCodes('&', s)).collect(Collectors.toList()));
    }
