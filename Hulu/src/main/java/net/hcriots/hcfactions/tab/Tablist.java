...
public class Tablist
{
    ...
    static {
        ...
        for (int i = 0; i < 80; ++i) {
            final int x = i % 4;
            final int y = i / 4;
            final String name = ((x > 9) ? ("§" + String.valueOf(x).toCharArray()[0] +
                    "§" + String.valueOf(x).toCharArray()[1]) : ("§0§" + x)) + ((y > 9) ?
                    ("§" + String.valueOf(y).toCharArray()[0] + "§" + String.valueOf(y).toCharArray()[1]) : ("§0§" + String.valueOf(y).toCharArray()[0]));
